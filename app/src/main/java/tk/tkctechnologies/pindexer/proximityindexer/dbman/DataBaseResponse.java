package tk.tkctechnologies.pindexer.proximityindexer.dbman;
...
public class DataBaseResponse {
    ...
    public static String getPostResponseData(String stringUrl, Uri.Builder builder, Context context) throws IOException {
        ...
        try {
            ...
            Log.e("Proximity Indexer", "MalformedURLException caught : " + e.getMessage());
        }
        Log.i("Proximity Indexer", "Returning result");
        return response;
    }
